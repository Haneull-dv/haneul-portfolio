...
async def check_footing(file: UploadFile = File(...)) -> FootingResponse:
    ...
    **지원 계정과목:**
    - 자산: 유동자산(현금및현금성자산, 매출채권및기타채권, 당기법인세자산, 금융자산, 기타자산, 재고자산, 매각예정비유동자산) + 비유동자산(매출채권및기타채권, 관계기업투자, 유형자산, 사용권자산, 투자부동산, 무형자산, 금융자산, 순확정급여자산, 기타자산, 이연법인세자산)
    - 부채: 유동부채(매입채무및기타채무, 금융부채, 리스부채, 당기법인세부채, 충당부채, 매각예정비유동부채, 기타부채) + 비유동부채(매입채무및기타채무, 금융부채, 리스부채, 충당부채, 기타부채, 순확정급여부채, 이연법인세부채)
    - 자본: 지배기업의소유지분(자본금, 주식발행초과금, 이익잉여금, 기타자본) + 비지배지분
    ...
    **엑셀 파일 구조:**
    ...
    Returns:
        ...
        - results: 연도별 검증 결과 (2024-12-31, 2023-12-31, 2022-12-31)
    """
